<template>
    <div class="nom-container py-8 nom-fade-in">
      <div class="max-w-3xl mx-auto">
        <!-- Back Button -->
        <div class="mb-6">
          <router-link to="/profile" class="inline-flex items-center text-muted-foreground hover:text-foreground transition-colors">
        ...
        <div v-if="isLoading" class="nom-card py-16 text-center">
          <div class="flex flex-col items-center justify-center">
            <svg class="animate-spin w-10 h-10 text-primary mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div v-else-if="errorMessage" class="nom-card py-12 text-center">
          <div class="flex flex-col items-center justify-center space-y-4">
            <svg class="w-16 h-16 text-destructive/60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div v-else class="space-y-6 nom-fade-in">
          <div class="nom-card">
            ...
            <!-- Error Message -->
            <div v-if="scheduleError" class="mt-4 p-3 bg-destructive/10 text-destructive rounded-md text-sm">
              {{ scheduleError }}
            </div>
          </div>
      ...
      <!-- Success Modal -->
      <div v-if="showSuccessModal" class="fixed inset-0 bg-foreground/20 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <div class="bg-card border border-border rounded-lg shadow-lg w-full max-w-md nom-slide-up">
          <div class="p-6">
            <div class="flex justify-end">
              <button @click="closeSuccessModal" class="p-1 rounded-full hover:bg-muted transition-colors">
            ...
            <div class="text-center mb-6">
              ...
              <p class="text-muted-foreground">Your order delivery has been scheduled successfully.</p>
            </div>
