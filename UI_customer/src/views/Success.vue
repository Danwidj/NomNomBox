<template>
  <div class="nom-container py-12 nom-fade-in">
    <div class="max-w-3xl mx-auto nom-card text-center">
      ...
      <h2 class="nom-heading mb-4">Payment Successful!</h2>
      <p class="text-muted-foreground text-lg mb-6">
        Thank you for your order. 
        Please go to your profile page to select a delivery date and time.
      </p>
